...
const Hero = () => {
  ...
  return (
    <section id="hero" className="min-h-screen relative flex items-center justify-center overflow-hidden py-4 sm:py-8 md:py-0">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 z-10 text-center max-w-4xl">
        <div className={`flex flex-col items-center mb-4 sm:mb-6 md:mb-8 transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          ...
          <div className="relative mb-4 sm:mb-6 md:mb-8">
            ...
            <Avatar className="h-24 w-24 sm:h-32 sm:w-32 md:h-40 md:w-40 border-2 sm:border-3 md:border-4 border-primary/80 shadow-xl md:shadow-2xl relative">
              <AvatarImage 
                src="/profile-pic.jpg" 
                alt="Parth Panchal" 
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 animate-fade-in px-4" style={{animationDelay: '0.4s'}}>
          <Button 
            variant="default" 
            size="lg" 
            className="bg-gradient-to-r from-primary to-blue-500 hover:opacity-90 transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg hover:shadow-primary/30 relative group overflow-hidden font-semibold text-sm sm:text-base lg:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto touch-manipulation"
          ...
          <Button 
            ...
            className="border-white/30 text-slate-50 bg-white/5 backdrop-blur-sm hover:bg-white/10 transition-all duration-300 hover:translate-y-[-2px] hover:shadow-lg relative group overflow-hidden font-semibold text-sm sm:text-base lg:text-lg px-6 sm:px-8 py-3 sm:py-4 w-full sm:w-auto touch-manipulation"
          >
